...
export const CallToAction = ({ onGetStarted, isSignedIn = false }) => {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="text-xl text-white/90 max-w-3xl mx-auto mb-8">
            {isSignedIn
              ? "Continue your innovation journey with instant insights and data-driven decisions."
              : "Get started now and receive instant insights to help you make data-driven decisions about your innovation."}
          </p>
          <button
          ...
          >
            ...
            {isSignedIn ? "Analyze Another Idea" : "Start Your Analysis"}
          </button>
          {!isSignedIn && (
